...
export class Pair {
  ...
  public constructor(currencyAmountA: TokenAmount, tokenAmountB: TokenAmount) {
    const tokenAmounts = currencyAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
